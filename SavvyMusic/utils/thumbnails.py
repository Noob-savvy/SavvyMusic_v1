...
async def get_thumb(videoid):
    ...
    try:
        ...
        font_size = 40
        font = ImageFont.truetype("SavvyMusic/assets/font2.ttf", font_size)
        font2_size = 70
        font2 = ImageFont.truetype("SavvyMusic/assets/font2.ttf", font2_size)
        arial = ImageFont.truetype("SavvyMusic/assets/font2.ttf", 30)
        name_font = ImageFont.truetype("SavvyMusic/assets/font.ttf", 40)
