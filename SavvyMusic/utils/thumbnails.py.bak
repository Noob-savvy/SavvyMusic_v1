# In SavvyMusic/utils/thumbnails.py
...
async def get_thumb(videoid, user_id):
    ...
    try:
        ...
        bg = Image.open(f"SavvyMusic/assets/savvy.jpeg")
        ...
        font = ImageFont.truetype("SavvyMusic/assets/font2.ttf", 45)
        ImageFont.truetype("SavvyMusic/assets/font2.ttf", 70)
        arial = ImageFont.truetype("SavvyMusic/assets/font2.ttf", 30)
        ImageFont.truetype("SavvyMusic/assets/font.ttf", 30)
        para = textwrap.wrap(title, width=32)
        try:
            draw.text(
                (450, 25),
                f"PLAYING ON SAVVY MUSIC",
                fill="white",
                stroke_width=3,
                stroke_fill="grey",
                font=font,
