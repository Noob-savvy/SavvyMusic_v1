...
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME","SAVVY MUSIC")

UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Noob-savvy/SavvyMusic_v1",
)
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "savvy")
GIT_TOKEN = getenv(
    "GIT_TOKEN", None
)  # Fill this variable if your upstream repository is private

SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/about_ranavanshi_divy")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/THE_WEBNET_NETWORK")
